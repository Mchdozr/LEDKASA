...
export const manufacturerGalleryManifest = [
  ...
  },
  {
    ...
    caption: '640×480-B — ön görünüm (960×960 Mg değil)',
  },
  {
  ...
  {
    file: 'cnc-640-ondan-bakim.webp',
    productSlug: 'cnc-led-kasa' as const,
    groupKey: '640-small-pitch-480' as const,
    caption: '640×480-B — önden bakım mıknatısı ve iç yapı',
  },
  {
    file: 'cnc-640-ozellik-ikonlari.webp',
    productSlug: 'cnc-led-kasa' as const,
    groupKey: '640-small-pitch-480' as const,
    caption: '640×480-B — föy özellik ikonları',
  },
  {
