...
export const products: Product[] = [
  ...
  },
  {
    ...
    gallery: [
      {
        src: '/assets/images/products/gallery/rental-960-urun-gorunumu.webp',
        alt: '960×960 mm rental LED kabinet ön ve arka görünümü',
        caption: 'Ön ve arka görünüm',
        groupKey: 'rental-960-mg',
        kind: 'cabinet-photo',
      },
      {
        src: '/assets/images/products/gallery/rental-960-olcu-diyagram.webp',
        alt: '960×960 mm rental LED kabinet ölçü diyagramı',
        caption: '960 × 960 mm ölçü',
        groupKey: 'rental-960-mg',
        kind: 'cabinet-photo',
      },
      {
      ...
      {
        src: '/assets/images/products/gallery/rental-960-ip65-yapi.webp',
        alt: '960×960 mm rental kabinet dış mekân IP65 yapı',
  ...
  },
  {
    ...
    description:
      'Katlanabilir Poster LED Kasa, ön bakımlı ve katlanabilir gövde yaklaşımıyla dikey LED poster uygulamalarında değerlendirilir. 640×1920 mm gövde profili; taşıma, braket ve yeniden kurulum akışı teklifte netleşir.',
    highlights: [
      'Ön bakım uyumlu gövde',
      'Katlanabilir poster ekran yaklaşımı',
      '640×1920 mm gövde profili',
    ...
    seoDescription:
      'Katlanabilir poster LED kasa: 640×1920 gövde, ön bakım, Mg/Al ağırlık ve pitch uyumu LEDKASA’da.',
  },
  {
    slug: 'cat6-kablo',
