...
export const products: Product[] = [
  {
    ...
    specGroups: [
      {
        ...
        groupKey: '960-mg',
        note: 'Magnezyum alaşım döküm kabinet profili. 640 mm küçük pitch gövdelerden ayrıdır.',
        specs: [
          { label: 'Kabinet ölçüsü', value: 'W960 × H960 × D87 mm' },
          ...
          { label: 'Güç kaynağı', value: '200W-5V 40A / 300W-5V 60A / 350W-5V 70A / 400W-5V 80A' },
          { label: 'Güç konektörü', value: '20A 3×2,5 mm²' },
    ...
    gallery: [
      ...
      },
      {
        ...
        alt: '960×960 mm LED kabinet dış mekân arka görünüm',
        caption: 'Dış mekân arka görünüm (IP65)',
        groupKey: '960-mg',
        kind: 'cabinet-photo',
      },
      {
  ...
  },
  {
    ...
    datasheets: [
      { url: '/assets/docs/poster-led-cabinet-overview.pdf', title: 'Poster LED kasa', meta: 'Teknik föy' },
    ],
  ...
  },
  {
    ...
    shortDescription: '500×2000 mm katlanır gövde — taşıma ve değişken yerleşim için poster LED kasa.',
    description:
      'Katlanabilir Poster LED Kasa, 500 × 2000 mm ekran ölçüsü ve katlanır alüminyum döküm gövde ile dikey LED poster uygulamalarında değerlendirilir. Katlanmış gövde derinliği 195 mm’dir; yan tutamak, hızlı kilit ve frenli döner tekerlek ile taşıma ve yeniden kurulum teklifte netleşir.',
    highlights: [
      'Ekran ölçüsü 500 × 2000 mm',
      'Katlanmış gövde derinliği 195 mm',
      'Alüminyum döküm siyah gövde — 24,66 kg',
      'Vidalı modül, arkadan bakım',
      'İç mekân ve dış mekân',
      'Yan tutamak, hızlı kilit, frenli döner tekerlek',
    ],
    specGroups: [
      {
        heading: 'Katlanabilir poster (500×2000 mm)',
        groupKey: 'foldable-500',
        note: 'Katlanır alüminyum döküm poster kasa. 640×1920 mm ön bakımlı gövde profilinden ayrıdır.',
        specs: [
      ...
      {
        heading: '640×1920 mm katlanabilir poster',
        note: 'Ön bakımlı Mg/Al alaşım gövde profili. 500×2000 mm katlanır poster ile karıştırılmaz.',
        specs: [
          { label: 'Kabinet ölçüsü', value: 'W640 × H1920 mm' },
          { label: 'Ağırlık', value: 'Mg 26 kg / Al 30 kg' },
          { label: 'Modül uyumu', value: 'P1 / P1.25 / P1.37 / P1.53 / P1.66 / P1.83 / P2 / P2.5 / P4 / P5' },
          { label: 'Suite / modül boyutu', value: '160 × 320 mm' },
          { label: 'Malzeme', value: 'Magnezyum alaşım / alüminyum alaşım' },
          { label: 'Kurulum tipi', value: 'Poster / reklam ekranı (katlanabilir)' },
          { label: 'Bakım yaklaşımı', value: 'Önden bakım' },
          { label: 'Ortam', value: 'İç mekân' },
          { label: 'Renk', value: 'Siyah (özel renk talebe göre)' },
          { label: 'Dahil aksesuarlar', value: 'Yaylı kilit, tutamak, sistem/güç plakası, braket' },
          { label: 'Güç kaynağı seçenekleri', value: '200W-5V 40A veya 300W-5V 60A' },
          { label: 'Güç konektörü', value: '20A 3×2,5 mm²' },
          { label: 'Flight case kapasitesi', value: '1 kabinet / kasa' },
        ],
      },
    ],
    gallery: [
      {
        src: '/assets/images/products/gallery/foldable-500-on-gorunum.webp',
        alt: '500×2000 mm katlanabilir poster LED kasa ön görünümü',
        caption: 'Ön görünüm',
        groupKey: 'foldable-500',
        kind: 'cabinet-photo',
      },
      {
        src: '/assets/images/products/gallery/foldable-500-yan-195mm.webp',
        alt: 'Katlanabilir poster LED kasa katlanmış gövde derinliği 195 mm',
        caption: 'Gövde derinliği 195 mm',
        groupKey: 'foldable-500',
        kind: 'cabinet-photo',
      },
      {
        src: '/assets/images/products/gallery/foldable-500-arka-gorunum.webp',
        alt: '500×2000 mm katlanabilir poster LED kasa arka görünümü',
        caption: 'Arka görünüm',
        groupKey: 'foldable-500',
        kind: 'cabinet-photo',
      },
    ...
    specsNote:
      '500×2000 mm katlanır profil ile 640×1920 mm ön bakımlı gövde ayrı tutulur. Taşıma formu, yerleşim adedi ve hatlar teklifte netleşir.',
    ...
    datasheets: [
      { url: '/assets/docs/foldable-poster-cabinet-640x1920.pdf', title: '640×1920 katlanabilir poster', meta: 'Teknik föy' },
    ],
    ...
    imageAlt: '500×2000 mm katlanabilir poster LED kasa ön görünümü',
    ...
    seoDescription:
      'Katlanabilir poster LED kasa: 500×2000 mm ekran, 195 mm gövde derinliği, alüminyum döküm ve arkadan bakım. Teklif süreci LEDKASA’da.',
  },
  {
    slug: 'cat6-kablo',
